...
public class Cuadrado extends FigurasGeometricas{
    ...
    public Cuadrado(double base, double altura, punto ubicacion){
    ...
    public void girar(char direccion) {
        ...
        if(direccion == 'I'){
            ...
            System.out.println( "El cuadrado gira a la izquierda: " + "(" + super.ubicacion.getX() + ", " + super.ubicacion.getY() + ")");
        } 
        if(direccion == 'D'){
            super.ubicacion.setX(super.ubicacion.getY());
            super.ubicacion.setY(aux_X);
            System.out.println( "El cuadrado gira a la derecha: " + "(" + super.ubicacion.getX() + ", " + super.ubicacion.getY() + ")");
