...
public class Numero implements Serializable {
    ...
    private boolean habilitado, reinicio_habilitado;
    ...
    public void amensaje(){
        if(intentos > 1){
            if(numeroa > numero){
                ...
                mensaje = "ACERTASTE"; 
                habilitado = true;
                reinicio_habilitado = false;
            }
        }else{
            mensaje = "Agotaste el número de intentos"; 
            intentos--;
            habilitado = true;
            reinicio_habilitado = false;
        }
    ...
    public boolean isReinicio_habilitado() {
        return reinicio_habilitado;
    }
