...
public abstract class Controladora<T> implements Serializable {
    ...
    public abstract void create(T object) throws RollbackFailureException, Exception;

    public abstract void edit(T object) throws NonexistentEntityException, RollbackFailureException, Exception;
