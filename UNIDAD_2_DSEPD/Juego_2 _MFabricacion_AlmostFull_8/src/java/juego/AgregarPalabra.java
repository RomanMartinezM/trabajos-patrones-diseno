...
public class AgregarPalabra extends ReglasNegocio{//HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Palabras p : listaPalabras) {
            if (p.getPalabra().equals(pal)) {
                existe = true;
                break;
            }
        }
        try {
            if (existe == false) {//si la palabra no existe
