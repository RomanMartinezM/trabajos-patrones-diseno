...
public abstract class Controladora<T> implements Serializable {
   ...
   // public abstract void create(Palabras palabras) throws RollbackFailureException, Exception;
    
    public abstract void edit(Object object) throws NonexistentEntityException, RollbackFailureException, Exception;
   // public abstract void edit(Palabras palabras) throws NonexistentEntityException, RollbackFailureException, Exception;
