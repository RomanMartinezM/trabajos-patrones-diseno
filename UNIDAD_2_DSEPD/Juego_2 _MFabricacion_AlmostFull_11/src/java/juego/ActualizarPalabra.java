 ...
 * @author lithium
 */
@WebServlet(name = "ActualizarPalabra", urlPatterns = {"/ActualizarPalabra"})
public class ActualizarPalabra extends ReglasNegocio {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            controlPal.edit(palabras);
            response.sendRedirect("ListarPalabras");
        } catch (RollbackFailureException ex) {
            Logger.getLogger(ActualizarPalabra.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(ActualizarPalabra.class.getName()).log(Level.SEVERE, null, ex);
        }   
    }
