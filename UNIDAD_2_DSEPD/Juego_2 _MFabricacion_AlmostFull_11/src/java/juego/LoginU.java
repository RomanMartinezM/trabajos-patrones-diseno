...
public class LoginU extends ReglasNegocio {
    public LoginU(){
        super();
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usuario = (Usuario)controlUsu.findModelo(Integer.parseInt(request.getParameter("idusu")));
        ...
        if (usuario == null) {//usuario no existe
            ...
            if (usuario.getNombre().equals(nombreUsuario) ) {
                 response.sendRedirect("agregar_juegos_usuario.jsp");
            }else{
