 ...
 * @author Edwin
 */
@WebServlet(name = "Mi_Serlet", urlPatterns = {"/Mi_Serlet"})
public class Mi_Serlet extends HttpServlet {
  private String usuarios[]={"administrador","invitado"};
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            response.sendRedirect("paginaPrincipal_1.jsp");
        }
        //response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Mi_Serlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Mi_Serlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
