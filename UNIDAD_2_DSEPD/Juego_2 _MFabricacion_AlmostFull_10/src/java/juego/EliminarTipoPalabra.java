 ...
 * @author lithium
 */
@WebServlet(name = "EliminarTipoPalabra", urlPatterns = {"/EliminarTipoPalabra"})
public class EliminarTipoPalabra extends ReglasNegocio {

    public EliminarTipoPalabra(){
        super();
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idtipo = tipos.getIdTipos();
        
        try {
            control.destroy(idtipo);
            response.sendRedirect("ListarTipos");
        } catch (RollbackFailureException ex) {
            Logger.getLogger(EliminarTipoPalabra.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(EliminarTipoPalabra.class.getName()).log(Level.SEVERE, null, ex);
        }   
    }
