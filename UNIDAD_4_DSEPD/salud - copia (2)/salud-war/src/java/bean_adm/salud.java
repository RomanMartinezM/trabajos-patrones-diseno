...
public class salud {
    ...
    public List<Antropometricos> lista_antro_por_idusuario(){
        ...
        for (int i = 0; i < antropometricos_ln.listaAntropometricos().size(); i++) {
            if (( antropometricos_ln.listaAntropometricos().get(i).getIdUsu().getIdUsuario())== u1timo_usuario().getIdUsuario()){//id_usuario) { //si el usuario ya esta registrado
   ...
   public Date obtenerFecha(){
    ...
    public String buscar_usuario(){
        ...
        for (int i = 0; i < usuarios_ln.listaUsuarios().size(); i++) {
            if ((usuarios_ln.listaUsuarios().get(i).getIdUsuario())==(id_usuario)
        ...
        if (usuarioExiste == true) {
           ...
           // buscar_datos_actusu(id_usuario);
            ...
            return "indicadores_salud";//"imc_icc"; 
        }else{
            intentos_aut++;
            return "login";
            //return "usuarios";
